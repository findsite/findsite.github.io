...
let descrs = ['Ебаная', 'Трамадольная', 'Шлюховитая', 'Обрыганная', 'Никчемная', 'Мразевидная', 'Глупи', 'Свинорылая', 'Собакорылая', 'Побитая', 'Проебавшаяся', 'Избитая', 'Кривая', 'Целлюлитная']
let titles = ['Сволочь', 'Тварь', 'Падла', 'Шлюха', 'Проститутка', 'Шаболда', 'Шваль', 'Шмара', 'Дурбецало', 'Свинья', 'Кабыла', 'Жиробасина', 'Мамонтиха', 'Обрыганка', 'Сосалка', 'Животное', 'Бараниха', 'Мелочь', 'Дур']
...
let shy_words = ['Любимая', 'Дорогая', 'Лучшая', 'Ненаглядная', 'Солнышко', 'Солнце', 'Любими', 'Красиви', 'Бести', 'Мая']
