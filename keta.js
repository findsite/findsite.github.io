...
let titles = ['Сволочь', 'Падла', 'Шлюха', 'Проститутка', 'Шаболда', 'Шваль', 'Шмара', 'Дурбецало', 'Свинья', 'Кабыла', 'Жиробасина', 'Мамонтиха', 'Обрыганка', 'Сосалка', 'Животное', 'Бараниха', 'Мелочь', 'Маугли', 'Лоутаб', 'Свиноматка', 'Пиздапроебина', 'Шмаровозка', 'Хуевертало']
